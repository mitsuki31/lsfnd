/**
 * A test module for `lsfnd-sync` package designed for CommonJS module (CJS).
 * @author Ryuu Mitsuki (https://github.com/mitsuki31)
 */

const path = require('node:path');
const { pathToFileURL } = require('node:url');
const { ls, lsFiles, lsDirs } = require('../dist/lsfnd-sync');
const { it, throws, doesNotThrow, deepEq } = require('./lib/simpletest');
